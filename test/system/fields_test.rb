...
class FieldsTest < ApplicationSystemTestCase
  ...
  test "creating a Field" do
    ...
    fill_in "Code", with: @field.code
    fill_in "Measures", with: @field.measures
    fill_in "Price", with: @field.price
    fill_in "Status", with: @field.status
    fill_in "Surface", with: @field.surface
    fill_in "Ubication", with: @field.ubication
