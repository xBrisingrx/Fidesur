json.data @fields do |f|
	...
	if f.bought? 
		json.actions "#{link_to '<i class="hs-admin-credit-card"></i>'.html_safe, show_field_sale_path(field_id:f.id), 
      							'class' => 'u-link-v5 g-color-gray-light-v6 g-color-secondary--hover g-text-underline--none--hover g-ml-12', title: 'Ver cuotas'}"
	end
end
